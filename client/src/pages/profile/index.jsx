    ...
    <div className='bg-[#1b1c24] h-[100vh] w-[100vw] flex items-center justify-center flex-col gap-10'>
      <div className='flex flex-col gap-10 w-[80vw] md:w-max'>
        ...
        <div className='grid grid-cols-2'>
            ...
            <Avatar className="h-32 w-32 md:h-48 md:w-48 rounded-full overflow-hidden" >
              {
                ...
                <div
                  className={`uppercase w-32 h-32 text-5xl border-[1px] flex items-center justify-center rounded-full md:w-48 md:h-48 ${getColors(selectedColor)}`}
          ...
          <div className='flex min-w-32 md:min-w-64 gap-5 flex-col items-center justify-center text-white'>
            <div className='w-full'>
              <Input placeholder="Email" type="email" disabled value={userInfo.email} className="rounded-lg p-6 bg-[#2c2e3b] border-none text-white"/>
            </div>
            <div className='w-full'>
            ...
            <div className='w-full flex gap-5'>
              {
                ...
                <div 
                className={`h-8 w-8 ${color} rounded-full transition-allcursor-pointer duration-300 ${selectedColor === index ? "outline outline-1 outline-white/50" : ""}`} 
                key={index}
        ...
        <div className='w-full'>
          <Button className="h-16 w-full bg-purple-900 transition-all duration-300" onClick={saveChanges}>Save Changes</Button>
        </div>
      </div>
    </div>
  )

    ...
    <>
        <TooltipProvider>
            <Tooltip>
                <TooltipTrigger>
                    <FaPlus 
                    className='text-neutral-400 font-light text-opacity-90 text-sm hover:text-neutral-100 text-start cursor-pointer transition-all duration-300'
        ...
        <Dialog open={openNewContactModal} onOpenChange={setOpenNewContactModal}>
            ...
            <DialogContent className="bg- [#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
                                ...
                                >
                                    <div className='w-12 h-12 relative'>
                                        <Avatar className="h-12 w-12 rounded-full overflow-hidden" >
                                        {
                                            ...
                                            <div
                                            className={`uppercase w-12 h-12 text-lg border-[1px] flex items-center justify-center rounded-full ${getColors(contact.color)}`}
...

                {
                    searchedContacts.length <=0 && 
                    <div
                        className='flex-1 md:flex flex-col items-center justify-center duration-1000 transition-all'
                    >
                        <Lottie
                        ...
                        />
                        <div
                        className='text-opacity-80 text-white flex flex-col gap-5 items-center mt-5 lg:text-2xl text-xl transition-all text-center duration-300'
                        >
